//an algorithm to find the symmetric difference of two arrays
//the symmetric difference of two arrays is the set of elements which are in either of the two arrays but not in both
//for example, the symmetric difference of [1,2,3] and [5,2,1,4] is [3,4,5]
...
function symmetricDifferences(numsA, numsB) {
    return  numsA
            .filter(i => !numsB.includes(i))
            .concat(numsB.filter(i => !numsA.includes(i)))
    //eh.. doesn't really work right. 
}

/*****************************************************************************/


console.log(symmetricDifferences(setA1, setA2))
